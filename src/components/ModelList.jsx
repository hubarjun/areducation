  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <motion.div
        ...
        className="mb-12"
      >
        <h2 className="text-3xl font-bold text-gray-900 mb-4">3D Learning Models</h2>
        <p className="text-gray-600">Explore our collection of interactive 3D models</p>
      </motion.div>
...
const models = [
  ...
  },
  {
    ...
    category: "Astronomy",
    image: "https://images.unsplash.com/photo-1614642264762-d0a3b8bf3700?auto=format&fit=crop&w=800"
  },
  {
    id: 3,
    ...
    image: "https://images.unsplash.com/photo-1621447504864-d8686f12c84a?auto=format&fit=crop&w=800"
  }
];
